...
##OBS: Ainda falta informar se o departamento não existe, e não dá
##pra excluir departamentos que tenham professores ou cursos cadastrados neles,
##ou seja, só dá pra excluir um departamento se ele tiver totalmente vazio.
